...
# resource "aws_iam_policy" "alb_cluster_policy" {
#   name        = "alb_cluster_policy"
#   description = "Policy required to use alb controller"
#   policy = jsonencode({
#     Version = "2012-10-17"
#     Statement = [
#       {
...
#         Condition = {
#           "Null" : {
#             "aws:ResourceTag/kubernetes.io/cluster/${var.namespace}" : "false"
#           }
#         }
#       },
#     ]
...
module "eks" {
  ...
  eks_managed_node_group_defaults = {
    ...
    #   "${resource.aws_iam_policy.alb_policy.arn}"
    # ]
  }
